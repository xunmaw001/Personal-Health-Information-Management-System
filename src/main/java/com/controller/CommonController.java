...
public class CommonController{
	 ...
	 * @return
	 */
	@RequestMapping("/newSelectGroupCount1")
	public R newSelectGroupCount1(@RequestParam Map<String,Object> params) {
		logger.debug("newSelectGroupCount1:,,Controller:{},,params:{}",this.getClass().getName(),params);
		List<Map<String, Object>> result = commonService.newSelectGroupCount1(params);
		return R.ok().put("data", result);
	}
