...
//                            yonghuEntity.setYonghuDanaawei(data.get(0));                    //所属单位 要改的
//                            yonghuEntity.setYonghuAddress(data.get(0));                    //现住址 要改的
//                            yonghuEntity.setAge(Integer.valueOf(data.get(0)));   //年龄 要改的
//                            yonghuEntity.setSexTypes(Integer.valueOf(data.get(0)));   //性别 要改的
//                            yonghuEntity.setDiquTypes(Integer.valueOf(data.get(0)));   //所在地区 要改的
