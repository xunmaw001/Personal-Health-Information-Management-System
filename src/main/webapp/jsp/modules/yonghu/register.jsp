...
<body style="background-image:url('/gerenjiankang/img/back-img-bg.jpg') !important;background-size:cover;">
<!-- Pre Loader -->
<div class="loading">
    <div class="spinner">
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="register">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    <label>所属单位</label>
                                    <input id="yonghuDanaawei" name="yonghuDanaawei" class="form-control"
                                           placeholder="所属单位">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>现住址</label>
