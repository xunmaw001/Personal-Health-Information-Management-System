                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 yonghuDanaaweiDiv">
                                        <label>所属单位</label>
                                        <input style="width: 450px" id="yonghuDanaawei" name="yonghuDanaawei" class="form-control"
                                               placeholder="所属单位">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 diquTypesDiv">
                                        <label>所在地区</label>
                                        <select style="width: 450px" id="diquTypesSelect" name="diquTypes" class="form-control">
                                        </select>
                                    </div>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                ...
                yonghuDanaawei: "所属单位不能为空",
                yonghuAddress: "现住址不能为空",
                age: "年龄不能为空",
                sexTypes: "性别不能为空",
                diquTypes: "所在地区不能为空",
