    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">体温分布统计</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">体温分布统计管理</li>
                        <li class="breadcrumb-item active">体温分布统计</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="layui-inline" style="margin-bottom: 10px;">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" id="insertTime" style="width: 200px;" class="form-control form-control-sm"
...
<script>
    ...
    function getDetails() {
        ...
        http("/newSelectGroupCount1", "GET", {
            tableName:"jiankangxinxi",
            groupColumn:"tiwen_types",
            riqi:val
        }, (res) => {
            if(res.code == 0){
